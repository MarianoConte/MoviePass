          ...
          <?php foreach ($shows as $show) { ?>
            <tr>
              ...
              <td class="text-right">
                ...
                <form class="d-inline-block" action="<?php echo FRONT_ROOT . '/Show/Delete'; ?>" method="post">
                  <input type="hidden" name="show_id" value=<?php echo $show->getId(); ?>>
                  <button type="submit" class="btn btn-sm btn-danger">Borrar</button>
                </form>

                <form class="d-inline-block" action="<?php echo FRONT_ROOT . '/Show/ShowEditView'; ?>" method="post">
                  <input type="hidden" name="show_id" value=<?php echo $show->getId(); ?>>
