                    ...
                    <tr class="<?php if (!$theater->getState()) echo 'disabled-row'; ?>">
                        ...
                        <td class="text-right">
                            ...
                            <form class="d-inline-block"
                                action="<?php echo FRONT_ROOT . '/Room/ShowListViewByTheater'; ?>" method="post">
                                <input type="hidden" name="theater_id" value=<?php echo $theater->getId(); ?>>
                                <button type="submit" class="btn btn-sm btn-info">Salas</button>
                            </form>

                            <form class="d-inline-block" action="<?php echo FRONT_ROOT . '/Theater/ShowEditView'; ?>"
                                method="post">
                                <input type="hidden" name="theater_id" value=<?php echo $theater->getId(); ?>>
                            ...
                            <form class="d-inline-block" action="<?php echo FRONT_ROOT . '/Theater/Desactivate'; ?>"
                                method="post">
                                <input type="hidden" name="theater_id" value=<?php echo $theater->getId(); ?>>
                                <button type="submit" class="btn btn-sm btn-danger">Deshabilitar</button>
                            </form>
                            <?php } else { ?>
                            <form class="d-inline-block" action="<?php echo FRONT_ROOT . '/Theater/Activate'; ?>"
                                method="post">
                                <input type="hidden" name="theater_id" value=<?php echo $theater->getId(); ?>>
